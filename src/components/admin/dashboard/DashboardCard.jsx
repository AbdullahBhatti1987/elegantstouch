...
export default function DashboardCard({
  ...
  return (
    <div
      ...
      className={`group relative overflow-hidden h-24 cursor-pointer rounded-2xl border border-gray-400 px-4 py-2 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md ${gradient} `}
    >
