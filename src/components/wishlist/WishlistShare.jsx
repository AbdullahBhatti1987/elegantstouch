...
export default function WishlistShare({ items = [] }) {
  ...
  return (
    <button
      onClick={handleShare}
      className="bg-primary flex items-center justify-center gap-1 rounded-lg px-3 py-2 text-xs text-white shadow-lg transition-all duration-200 hover:opacity-90 active:scale-95 active:shadow-inner sm:gap-2 sm:px-4 sm:text-sm"
    >
