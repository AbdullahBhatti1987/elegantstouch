...
export default function CartItem({
  ...
  return (
    <div className="relative flex gap-3 rounded-xl border bg-white p-3 shadow-sm transition hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900">
      {/* Remove Button */}

      <button
        onClick={onRemove}
        aria-label={`Remove ${item.name}`}
        className="absolute top-2 right-2 flex h-7 w-7 items-center justify-center rounded-full text-gray-400 transition hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-950"
      >
        <X size={17} />
      </button>
